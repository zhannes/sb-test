...
var SharedThemeProvider = ThemeProvider__default["default"];
var sharedCreateTheme = createTheme__default["default"];
function BasicButton(_ref2) {
  ...
  return /*#__PURE__*/React__namespace.createElement(Stack__default["default"], {
    spacing: 2,
    direction: "row"
  }, /*#__PURE__*/React__namespace.createElement(Button__default["default"], Object.assign({
    variant: "outlined"
  }, props), children));
}
function Test(_ref3) {
...
exports.SharedThemeProvider = SharedThemeProvider;
exports.Test = Test;
exports.ThemeProviderComponent = ThemeProviderComponent;
exports.sharedCreateTheme = sharedCreateTheme;
exports.theme = theme;
